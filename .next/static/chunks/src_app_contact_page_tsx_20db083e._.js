    ...
    async function submit(e) {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error((j === null || j === void 0 ? void 0 : j.error) || "Verzenden mislukt");
            }
            setDone(true);
            setEmail("");
            setMessage("");
            ...
            var _err_message;
            setError((_err_message = err.message) !== null && _err_message !== void 0 ? _err_message : "Er ging iets mis");
        } finally{
            setSending(false);
        }
    }
...
_s(Contact, "v/0jHru4wT+MM+YcQSkjA277ObA=");
_c = Contact;
var _c;
